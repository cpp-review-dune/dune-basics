...
\institute[]
{
  ...
  \begin{center}
  Disponible en \href{https://github.com/cpp-review-dune}{\includegraphics[width=0.6cm]{GitHub-Mark-120px-plus}}
  \end{center}

  \begin{center}
  ¡Únete al grupo en Telegram!
  \href{https://t.me/joinchat/OsfYP1xnFlxjN2Ix}{\includegraphics[width=0.6cm]{telegram-logo}}
  \end{center}
}
