...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\href{https://cmake.org/cmake/help/latest/command/cmake\_minimum\_required.html}{\lstinline{cmake_minimum_required()}}
		...
		\href{https://cmake.org/cmake/help/latest/command/add\_executable.html}{\lstinline{add_executable()}}}
